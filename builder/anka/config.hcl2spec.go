...
type FlatConfig struct {
	...
	InstallerApp              *string           `mapstructure:"installer_app" cty:"installer_app"`
	SourceVMName              *string           `mapstructure:"source_vm_name" cty:"source_vm_name"`
	...
	CPUCount                  *string           `mapstructure:"cpu_count" cty:"cpu_count"`
	BootDelay                 *string           `mapstructure:"boot_delay" cty:"boot_delay"`
	EnableHtt                 *bool             `mapstructure:"enable_htt" cty:"enable_htt"`
	DisableHtt                *bool             `mapstructure:"disable_htt" cty:"disable_htt"`
}
